...
class _SettingsScreenState extends State<SettingsScreen> {
          ...
          children: [
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: Text(
                      'Change Password',
                      style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 14, color: onSurface),
                    ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  SwitchListTile(
                    ...
                    activeTrackColor: primaryColor,
                    secondary: Icon(Icons.vibration_outlined, color: primaryColor),
                    title: Text(
                      'Haptic Vibration',
                      style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 14, color: onSurface),
                    ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ListTile(
                    onTap: () => _showInfoDialog(context, 'Help Center', 'Our knowledge base is available 24/7 at support@lumina.edu.'),
                    leading: Icon(Icons.help_center_outlined, color: primaryColor),
                    title: Text(
                      'Help Center',
                      style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 14, color: onSurface),
                    ),
                  ...
                  const Divider(height: 1, indent: 56),
                  ListTile(
                    onTap: () => _showInfoDialog(context, 'Privacy Policy', 'We treat your privacy with extreme responsibility. We keep data secure locally.'),
                  ...
                  const Divider(height: 1, indent: 56),
                  ListTile(
                    onTap: () => _showInfoDialog(context, 'Terms & Conditions', 'By using Lumina, you agree to local processing and academic integrity rules.'),
                  ...
                  const Divider(height: 1, indent: 56),
                  ListTile(
                    onTap: () => _showInfoDialog(context, 'Contact Support', 'Submit a support ticket directly to our engineers at contact@lumina.edu.'),
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: Text(
                      'Log Out',
                      style: GoogleFonts.inter(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.redAccent),
                    ),
                  ),
                  const Divider(height: 1, indent: 56),
                  ListTile(
  ...
  void _showEditProfileDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text('Edit Profile', style: GoogleFonts.plusJakartaSans(color: Colors.white, fontWeight: FontWeight.bold)),
        content: Column(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              state.editProfile(nameController.text.trim(), emailController.text.trim());
  ...
  void _showChangePasswordDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: const Color(0xFF213145),
        title: Text('Change Password', style: GoogleFonts.plusJakartaSans(color: Colors.white, fontWeight: FontWeight.bold)),
        content: TextField(
  ...
  void _showInfoDialog(BuildContext context, String title, String message) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: const Color(0xFF213145),
        title: Text(title, style: GoogleFonts.plusJakartaSans(color: Colors.white, fontWeight: FontWeight.bold)),
        content: Text(message, style: GoogleFonts.inter(color: Colors.white70)),
        actions: [
          TextButton(onPressed: () => Navigator.pop(context), child: const Text('OK', style: TextStyle(color: Color(0xFF6366F1)))),
        ],
      ),
    );
  }
  ...
  void _showDeleteConfirmDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor: const Color(0xFF213145),
        title: Text('Delete Account', style: GoogleFonts.plusJakartaSans(color: Colors.red, fontWeight: FontWeight.bold)),
        content: Text('Are you sure you want to permanently delete your account? This action is irreversible.', style: GoogleFonts.inter(color: Colors.white70)),
        actions: [
          TextButton(onPressed: () => Navigator.pop(context), child: const Text('Cancel', style: TextStyle(color: Colors.grey))),
          TextButton(
            onPressed: () {
